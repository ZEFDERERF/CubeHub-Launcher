				...
				<div class="settings-main">
					...
					<div class="settings-content">
						<div class="scrollable-content">
							<!-- 个性化设置 -->
							<div
								v-show="currentSection === 'personalization'"
							...
							>
								...
								<div class="setting-item">
									...
									<div class="color-picker" :class="{ disabled: isRGBMode }">
										<div
											...
											:class="[
												'color-option',
												{
													active: primaryColor === color.value,
													disabled: isRGBMode,
												},
											]"
									...
									<div
										class="color-custom-section"
										:class="{ disabled: isRGBMode }"
									>
									...
									<div class="control-settings">
										...
										<div class="setting-row">
											...
											<button
												class="toggle-btn"
												:class="{
													active: homeSettings.showRecentGames.value,
												}"
												@click="toggleRecentGames"
											>
												{{
													homeSettings.showRecentGames.value
														? '隐藏'
														: '显示'
												}}
											</button>
								...
								<div class="setting-item">
									<div class="game-dir-input">
										<input
											...
											:title="gamePath"
										/>
										<button class="primary-btn" @click="browseGamePath">
											选择目录
										</button>
									</div>
									<button class="secondary-btn" @click="resetToDefaultDir">
										重置为默认目录
									</button>
								</div>
								...
								<div class="setting-item">
									<div class="game-dir-input">
										<input
											...
											:title="javaPath"
										/>
										<button class="primary-btn" @click="browseJavaPath">
											选择Java
										</button>
									</div>
								</div>
...
// 监听值变化并存
watch(
	[minMemory, maxMemory, language, downloadSource, maxDownloads],
	([newMin, newMax, newLang, newSource, newDownloads]) => {
