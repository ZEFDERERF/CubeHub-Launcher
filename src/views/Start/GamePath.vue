<template>
	<div class="game-path-container">
		...
		<div class="settings-box">
			<div class="form-group">
				...
				<div class="input-group">
					<input type="text" v-model="gamePath" placeholder="请选择游戏目录" readonly />
					<button class="browse-button" @click="selectGamePath">浏览</button>
				</div>
				<p class="path-info">默认目录：{{ defaultGamePath }}</p>
			</div>
		...
		<div class="actions">
			<button class="back-button" @click="router.push('/start/java')">返回</button>
			<button class="next-button" :disabled="!canProceed" @click="handleNext">
				完成设置
			</button>
		</div>
	</div>
